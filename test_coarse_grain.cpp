 ...
 */
void insert_worker(CoarseGrainList<int> &list, int start, int end) {
 ...
 * @param id Thread ID
 */
void mixed_worker_no_delete(CoarseGrainList<int> &list, int id) {
 ...
 */
void mixed_worker_all_delete(CoarseGrainList<int> &list, int thread_id) {
 ...
 */
bool check_separate_workers(CoarseGrainList<int> &list) {
  for (int i = 0; i < NUM_OPERATIONS; ++i) {
    if (list.find(i)) {
      return false;
    }
